...
KindEditor.plugin('emoticons', function(K) {
	var self = this, name = 'emoticons',
		path = (self.emoticonsPath || '/KE/plugins/emoticons/images/'),
...
KindEditor.plugin('image', function(K) {
	var self = this, name = 'image',
		...
		formatUploadUrl = K.undef(self.formatUploadUrl, true),
		allowFileManager = K.undef(self.allowFileManager, false),
		uploadJson = K.undef(self.uploadJson, self.basePath + 'upload_img'),
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + target + '" action="' + K.addParam(uploadJson, 'dir=upload') + '">',
			//file
			'<div class="ke-dialog-row">',
			hiddenElements.join(''),
